...
Die benötigte XML-Datei (`belt_state.xml`) sowie dein Arbeitsblatt (`robot_sorting_exercise.py`) liegen bereits fertig

vorbereitet in diesem Ordner. Schau dir die XML-Datei kurz in VSCode an, um zu sehen, welche Paketgewichte auf den Roboter warten!
